...
function dialogAjaxMenu(json){
	...
	if (json.statusCode == DWZ.statusCode.ok){
		$("#sidebar").loadUrl("__APP__/Ui/menu");
	}
}
...
<body scroll="no">
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				<div class="logo"><a href="__APP__">Logo</a></div>
                <div id="navMenu">
                    <ul>
                    <?php if(is_array(C("ADMIN_BMENU"))): $i = 0; $__LIST__ = C("ADMIN_BMENU");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/Ui/menu/group/<?php echo ($key); ?>"><span><?php echo ($vo); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?><!--顶部大菜单-->
                    </ul>
                </div>
                <div class="right">
                    <ul class="nav">
                        <li class="first"><a href="__ROOT__/" target="_blank">前台首页</a></li>
                        <li><a href="__ROOT__/plugin/caiji/" target="_blank">采集系统</a></li>
                        <li><a href="__APP__/Public/main/" target="dialog" width="580" height="500" rel="sysInfo">系统信息</a></li>
                        <li><a href="__APP__/Public/password/" target="dialog" width="520" height="270" mask="true">修改密码</a></li>
                        <li><a href="__APP__/Public/profile/" target="dialog" width="560" height="300" mask="true">修改资料</a></li>
			...
			<div id="navTab" class="tabsPage">
				<div class="tabsPageHeader">
					<div class="tabsPageHeaderContent"><!-- 显示左右控制时添加 class="tabsPageHeaderMargin" -->
						<ul class="navTab-tab">
							<li tabid="main" class="main"><a href="javascript:void(0)"><span><span class="home_icon">我的桌面</span></span></a></li>
						</ul>
					</div>
				...
				<ul class="tabsMoreList">
					<li><a href="javascript:void(0)">我的桌面</a></li>
				</ul>
				<div class="navTab-panel tabsPageContent">
					<div>
						<div class="accountInfo">
							...
							<p><div style="float:left">欢迎光临, <?php echo (session('loginUserName')); ?></div><div style="float:left"><iframe frameborder="0" scrolling="no" width="500" height="15" src="http://www.cmshead.com/version.php?v=<?php echo (C("cmshead_version")); ?>"></iframe></div></p>
						</div>
					</div>
				</div>
			</div>
