	...
	<div class="layoutBox">
            ...
            <div class="searchBar">
                <ul class="searchContent">
                    <li>
                        <label>分类：</label>
                        <label>
                        <input type="text" size="30" readonly="readonly" id="categoryName_article" name="categoryName" value="<?php if(!empty($_REQUEST['categoryName'])): echo ($_REQUEST['categoryName']); else: echo (getcategoryname($_REQUEST['tid'])); endif; ?>"/>
                        <a class="unit btn" href="__APP__/Ui/tree/selparent/1/selmore/1/cid/tid_article/cname/categoryName_article/selroot/1" target="dialog" rel="tree" mask="true" title="选择分类" width="600" height="650">选择分类</a>
                        <input type="hidden" id="tid_article" name="tid" value="<?php echo ($_REQUEST['tid']); ?>" />
                        </label>
                    </li>
                    <li>
                        <label>查找范围：</label>
		...
		<div class="panelBar">
			<ul class="toolBar">
                ...
                <li class="line">line</li>
				<li><a class="edit" href="__URL__/copy" target="selectedTodo" showType="dialog" posttype="string" rel="id" width="500" height="200" mask="true" alt="复制信息到某些栏目" warn="请至少选择一条记录"><span>复制</span></a></li>
