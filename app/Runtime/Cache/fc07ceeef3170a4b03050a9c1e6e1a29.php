...
<section class="tab-top">
  <div class="tabs">
    <a href="<?php echo U('Index/about');?>">园区介绍</a>
    <a href="<?php echo U('Index/join');?>" class="selected">加入协会</a>
  </div>
  <h1 class="title-line"><span>加入协会</span><hr></h1>
</section>
<section class="association-Introduction pg-part-bg">
  <div class="wrap row-fluid">
    <div class="span3"><img src="__PUBLIC__/images/logo2.png" alt=""/></div>
    <div class="span8">
      <h1>上海机器人协会 SHANGHAI ROBOT INDUSTRY ASSOCIATION <br>
        简称“SRIC”</h1>
      <p>协会积极组织上海产学研各界参与产业发展战略研究、产学研重大专项、产业孵化器建设，引导传统产业进入机器人产业领域。致力于传播、推广和发展先进的机器人技术和产品；搭建厂家和中国科学院交流和学习的平台；构筑企业和政府沟通的桥梁；推进机器人专业人才培养。</p>
    </div>
  </div>
</section>
<section class="association-function">
  <div class="wrap">
    <h1 class="title-line2"><span>协会职能</span><hr/></h1>
    <div class="row-fluid">
      <div class="span6">
        <ul>
          <li> • 宣传政府的政策、法规</li>
          <li>• 提出行业政策和法规的建议和意见</li>
          <li>• 进行行业统计、调查</li>
          <li>• 向有关部门反映会员、行业的困难和要求，并协助解决</li>
          <li>• 制订行业发展规划</li>
        </ul>
      </div>
      <div class="span6">
        <ul>
          <li>• 协助有关部门打击假冒伪劣活动</li>
          <li>• 组织有关政策法规、机器人安全标准及质量技术、企管等培训</li>
          <li>• 定期向会员提供国内外机器人行业的资讯，发布有关行业消息</li>
          <li>• 组织国内外同行之间的交流活动</li>
          <li>• 组织会员参加国内外大型机器人展览会</li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="association-services pg-part-bg">
  <div class="wrap">
    <h1 class="title-line2"><span>会员服务介绍</span><hr/></h1>
    <div class="row-fluid">
      <div class="span6">
        <h2>资源共享</h2>
        <p>会员名录 <br>
          协会网站(http://www.robotsh.cn） <br>
          每月最新政策信息</p>
      </div>
      <div class="span6">
        <h2>学习发展</h2>
        <p>
          中国科学院深圳先进技术研究院专家、教授技术支持<br>
          年度机器人行业优秀企业和个人评选<br>
          各类专业培训、研讨会、公开课<br>
          定期机器人专题论坛<br>
          行业专家、政府权威部门咨询服务<br>
...
<section class="association-services2">
  <div class="wrap">
    <h1 class="title-line2"><span>会员服务</span><hr/></h1>
    <p class="em">我们热诚欢迎更多相关行业的公司/机构加入我们的行列，学习交流、共享资源，努力提升机器人企业的价值，为机器人行业发展做出贡献。</p>
    <div class="row-fluid steps">
      <div class="span4">
        <h1>入会申请</h1>

        <p>联系协会秘书处，申请加入协会。填写《上海机器人协会会员申请表》加盖公章，连同加盖公章的公司营业执照复印件一并寄送至协会秘书处。</p>
      </div>
      <div class="span4">
        <h1>资质审核</h1>

        <p>协会秘书处将对会员单位资质进行审核，经核准符合协会入会要求，3个工作日内与申请单位确认。</p>
      </div>
      <div class="span4">
        <h1>会员确认</h1>

        <p>协会收到会费后，5个工作日内将会费收据以快递方式寄出，并发放会员牌匾。 </p>
      </div>
    </div>
    <div class="row-fluid pdf-row">
      <div class="span4">
        <div class="span4"><img src="__PUBLIC__/images/icon-pdf.png" alt=""/></div>
        <div class="span8">
          <h3>机器人协会章程</h3>
...
<section id="contact" class="pg-part-bg">
  <div class="wrap">
    <h1 class="title-line2"><span>联系我们</span><hr/></h1>
    <div class="row-fluid">
      <div class="span8">
        <img src="__PUBLIC__/images/map-mask.jpg" alt=""/>
      </div>
      <div class="span4">
        <p class="way">
          电话：021-56022147 <br>
          传真： 021-56022809<br>
          邮箱：robot@robotsh.cn<br>
          网址：http:// www.robotsh.cn<br>
