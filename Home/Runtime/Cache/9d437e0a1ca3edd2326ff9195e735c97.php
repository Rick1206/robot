...
<body>
    ...
    <div class="wrap_left">
        ...
        <!--pageBox-->
        <div id="pageBox">
            <?php $_result=Sys::page('Download','page:5');if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!--page:5:pageBox则为ajax分页模式-->
            <div class="art_block">
                ...
                <div class="art_center"><?php endif; ?>
                    ...
                    <div class="right">
                        ...
                        <div>[<a href="<?php echo ($vo["classurl"]); ?>"><?php echo ($vo["classtitle"]); ?></a>]  软件版本：<?php echo ($vo["rjbb"]); ?> 点击次数：<?php echo ($vo["apv"]); ?>次 发表时间：<?php echo (date('Y-m-d H:i:s',$vo["add_time"])); ?></div>
                        <p><?php echo (encode($vo["description"],300)); ?></p>
                    </div>
                </div>
