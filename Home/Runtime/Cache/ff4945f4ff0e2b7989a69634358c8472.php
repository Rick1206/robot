...
<section class="pg-head">
  <div class="wrap">
    ...
    <div class="short-img"><img src="__PUBLIC__/Theme/Front/images/about-short-pic01.png" alt=""/></div>
  </div>
</section>
<section class="tab-top">
  <div class="tabs">
    <a href="<?php echo U('Index/product',array(id=>1));?>" class="selected">教育</a>
...
<section class="dynamic wrap">
  <div class="row-fluid">
    ...
    <div class="span4 index-ref-block">
      ...
      <p>把机器人放在眼睛里做医疗手术可能是下一个创新趋势，苏黎世的研究人员正在建立微型机器人用来帮助精致的手术，机器人有一个可伸缩的针来探测身体部位（眼睛），针的直径只有4分之一毫米 </p>
      <a href="" class="link-btn">了解更多</a>
      <a href="" class="link-btn">我要租赁</a>
    </div>
  </div>
</section>
<section class="tab-top2">
  <div class="tabs">
    <a href="" class="selected">转让</a>
    <a href="">租赁</a>
    <a href="">采购</a>
  </div>
</section>
